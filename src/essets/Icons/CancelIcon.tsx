const CancelIcon = ({color}: {color: string}) => (
  <svg aria-hidden="true" focusable="false" data-icon="window-close" role="img"  width="42" height="32" color={color} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
